...
public class ConsoleTest {
	...
	public void postEstadiaTest() {

		Estadia e = new Estadia();
		
		e.setConsumo_pago(200d);
		e.setDiarias_consumidas(3);
		e.setDiarias_pagas(3);
		e.setDiarias_reservadas(3);
		e.setIsAtivo(true);
		e.setObservacoes("blbobloblbobloblbolob");
		e.setQtde_hospede(2);
		...
		String entityResponse = HttpConnector.savePostConnect("http://localhost:8080/ws_pousada/estadia/save",
				jsonInString);
